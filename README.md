...
| [`ckanext-geoview (sddi-base)`](https://github.com/ckan/ckanext-geoview), [`ckanext-geoview (sddi-urban)`](https://github.com/gislab-augsburg/ckanext-geoview) | `v0.2.2`, `0814664` | :heavy_check_mark: | :heavy_check_mark: | Diese Erweiterung enthält Ansichts-Plugins, um raumbezogene Dateien und Dienste (z.B. WMS) in CKAN anzuzeigen. |
...
| [`ckanext-resourcedictionary`](https://github.com/gislab-augsburg/ckanext-resourcedictionary) | `275ae3e` |  | :heavy_check_mark: | Erweitert die Standardfunktionalität des CKAN Data Dictionary, indem die Möglichkeit hinzugefügt wird, ein Data Dictionary zu erstellen, bevor die tatsächlichen Daten in den Datenspeicher hochgeladen werden..  |
...
| [`ckanext-lhm`](https://github.com/gislab-augsburg/ckanext-lhm/tree/ckan-211-3) | `73a0ab2` |  | :heavy_check_mark: | Fügt Optionen für ein benutzerdefiniertes Metadaten-Schema, benutzerdefinierte Frontend-Gestaltung, ein angepasstes Set von Gruppen und Themen sowie angepasste Export- und Harvesting-Funktionen hinzu, inspiriert durch die Anforderungen der LHM an Datenkataloge für kommunale und städtische Digitale Zwillinge. |
...
| [`ckanext-iso`](https://github.com/gislab-augsburg/ckanext-iso/tree/dev) | `0ee200d` |  | :heavy_check_mark: | Überarbeitung und Anpassung des CSW-Harvesters von ckanext-spatial an die Anforderungen der LHM für das Harvesting von ISO-19115 Metadaten via CSW-Schnittstelle.  |
| [`ckanext-keycloak`](https://github.com/gislab-augsburg/ckanext-keycloak/tree/ckan-2.11) | `1f57fcb` |  | :heavy_check_mark: | Fügt Optionen für Single Sign-On hinzu und ermöglicht es Benutzern, sich automatisch mit Keycloak zu authentifizieren und einzuloggen. |
| [`ckanext-noanonaccess`](https://github.com/gislab-augsburg/ckanext-noanonaccess/tree/lhm_redirect) | `290ca76` |  | :heavy_check_mark: | Bietet die Option, den Zugang zu einem Metadatenkatalog oder bestimmten Funktionen auf registrierte Benutzer zu beschränken. |
