...
| [`ckanext-keycloak`](https://github.com/gislab-augsburg/ckanext-keycloak) | `1f57fcb` |  | :heavy_check_mark: | Fügt Optionen für Single Sign-On hinzu und ermöglicht es Benutzern, sich automatisch mit Keycloak zu authentifizieren und einzuloggen. |
