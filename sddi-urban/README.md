...
| [`lhm`](https://github.com/MandanaMoshref/ckanext-lhm) | `d28dbfa` |  |  |  | :heavy_check_mark: | Adds options for a custom metadata schema, custom theming and an adapted set of groups and topics, provided by Landeshauptstadt München (LHM).  |
...
| [`noanonaccess`](https://github.com/gislab-augsburg/ckanext-iso) | `v2.0.4` |  |  |  | :heavy_check_mark: | Restricts access to registered users only. |
| [`keycloak`](https://github.com/gislab-augsburg/ckanext-keycloak) | `5859aec` |  |  |  | :heavy_check_mark: | Adds Single Sign On options and enables users to authenticate with Keycloack instead of creating a new user account. |
| [`clamav`](https://github.com/gislab-augsburg/ckanext-clamav) | `c483b5d` |  |  |  | :heavy_check_mark: | Scans uploaded resource files for malwares with clamd library. |
